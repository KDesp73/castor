...
- Dying transports you to the previous level
...
- Refactored engine into modules
- Bumped version to 1.1.3
- Moved engine in its own directory
...
- Using versioning on libraries
- Building process shares common dependencies across projects
...
- Included all dependencies inside the project
- Keeping sprite when activating the glasses
...
- Close to working floor and ceiling rendering
...
[1.1.0]: https://github.com/KDesp73/castor/releases/tag/v1.1.0
[1.1.1]: https://github.com/KDesp73/castor/releases/tag/v1.1.1
[1.1.2]: https://github.com/KDesp73/castor/releases/tag/v1.1.2
[1.1.3]: https://github.com/KDesp73/castor/releases/tag/v1.1.3
[1.1.4]: https://github.com/KDesp73/castor/releases/tag/v1.1.4
[1.1.5]: https://github.com/KDesp73/castor/releases/tag/v1.1.5
[1.1.6]: https://github.com/KDesp73/castor/releases/tag/v1.1.6
